...
</div><form method='post' action="payment.php">
...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="form-group">
            <label type="number" data-toggle="tooltip" title="ex: '123'" data-original-title="3 digits code on back side of the card">CVV <i class="fa fa-question-circle"></i></label>
            <input class="form-control" required="" type="text">
        </div> <!-- form-group.// -->
    </div>
</div> <!-- row.// -->
<a href="thanku.php"><button class="subscribe btn btn-primary btn-block" type="button"> Confirm  </button></a>
</form>
</div> <!-- card-body.// -->
</article> <!-- card.// -->
...
<ul class="nav bg-light nav-pills rounded nav-fill mb-3" role="tablist">
	<li class="nav-item">
		...
		<i><img width="30px" height="30px"
		src="https://cdn1.iconfinder.com/data/icons/cash-card-add-on/48/v-06-512.png"></i> Cash</a></li>
	<li class="nav-item">
